        ...
        if action == 'generate':
            ...
            if not drafts:
                ...
                if "Error" in final_draft:
                    ...
                    # Apply grammar zap if not already done
                    ...
                    # Generate SEO summary (meta description) - Made anonymous
                    seo_summary = f"{generated_title} - Explore insights on {primary_keyword} and more."

                    # Convert publish_date to ISO format for Airtable
                    try:
                    ...
                    # Get the current timestamp for the "Created At" field (without microseconds)
                    ...
                    data = {
                        'records': [{
                            'fields': {
                                ...
                                'Status': 'Scheduled',
                                'Created At': created_at_iso  # Updated field
                            }
                        }]
                    }
